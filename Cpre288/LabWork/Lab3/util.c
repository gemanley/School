...
#warning "Unimplemented function: uchar read_push_buttons(void)"	// delete this line after implementing
...
#warning "Unimplemented function: char read_shaft_encoder(void)"	// delete this line after implementing
	...
	static uchar old_value = REPLACEME;		// Step 2: Based on how you decided to mask PINC in step 1, what would new_value be if the switch is in a groove?
	
	// Function variables
	uchar new_value = REPLACEME;			// Step 1: Decide how to read PINC so that the push buttons are masked
	char rotation = 0;
